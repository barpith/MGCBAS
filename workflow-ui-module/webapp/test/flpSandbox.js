		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bpadispatch2workflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpadispatch2workflowuimodule-display": {
								"semanticObject": "bpadispatch2workflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpadispatch2.workflowuimodule",
									"url": sap.ui.require.toUrl("bpadispatch2/workflowuimodule")
								}
							}
						}
					}
