		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgccrewprdworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgccrewprdworkflowuimodule-display": {
								"semanticObject": "commgccrewprdworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.crewprd.workflowuimodule",
									"url": sap.ui.require.toUrl("com/mgc/crewprd/workflowuimodule")
								}
							}
						}
					}
