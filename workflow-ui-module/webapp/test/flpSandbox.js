		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgcconscrewprdworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgcconscrewprdworkflowuimodule-display": {
								"semanticObject": "commgcconscrewprdworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.conscrewprd.workflowuimodule",
									"url": sap.ui.require.toUrl("com/mgc/conscrewprd/workflowuimodule")
								}
							}
						}
					}
