		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bpadispatch3workflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpadispatch3workflowuimodule-display": {
								"semanticObject": "bpadispatch3workflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpadispatch3.workflowuimodule",
									"url": sap.ui.require.toUrl("bpadispatch3/workflowuimodule")
								}
							}
						}
					}
