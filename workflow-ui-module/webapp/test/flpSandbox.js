		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgcbpadispatchworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgcbpadispatchworkflowuimodule-display": {
								"semanticObject": "commgcbpadispatchworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.bpadispatch.workflowuimodule",
									"url": sap.ui.require.toUrl("com/mgc/bpadispatch/workflowuimodule")
								}
							}
						}
					}
