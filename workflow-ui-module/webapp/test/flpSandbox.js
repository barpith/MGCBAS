		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgctaskuicrewworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgctaskuicrewworkflowuimodule-display": {
								"semanticObject": "commgctaskuicrewworkflowuimodule",
								"action": "display",
								"description": "A workflow task UI application for crew",
								"title": "Task UI app title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.taskuicrew.workflowuimodule",
									"url": sap.ui.require.toUrl("com/mgc/taskuicrew/workflowuimodule")
								}
							}
						}
					}
