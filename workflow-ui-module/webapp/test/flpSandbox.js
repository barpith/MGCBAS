		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgcbpaofficeworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgcbpaofficeworkflowuimodule-display": {
								"semanticObject": "commgcbpaofficeworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.bpaoffice.workflowuimodule",
									"url": sap.ui.require.toUrl("com/mgc/bpaoffice/workflowuimodule")
								}
							}
						}
					}
