sap.ui.define(
  [
    ...
    "com/mgc/conscrewprd/workflowuimodule/model/models",
  ...
  function (UIComponent, Device, JSONModel, MessageBox, Fragment, Filter, FilterOperator, models,XMLView) {
    ...
    return UIComponent.extend(
      "com.mgc.conscrewprd.workflowuimodule.Component",
      {
        metadata: {
          manifest: "json",
        },
                ...
                console.log("context " +tableData);
                    ...
                    if (tableData.length > 0){
                        for (var i = 0; i < tableData.length; i++) {
                            ...
                            var batchOperation = oDataModel.createBatchOperation("/TimeSheetDetails(ID="+dataPayload.ID+",AppName='CP_CREW',Date='"+dataPayload.Date+"')", "PATCH", dataPayload);
